			...
			}else
			{
				...
				if($plan_tugruero == true and $plan_rcv == true){
					...
					$array_json['data'][] = array(
						...
						<ul class="dropdown-menu dropdown-menu-right">
						<li><a href="'.full_url.'/adm/solicitud_plan/index.php?action=edit&idSolicitudPlan='.$idSolicitudPlan.'"> <i class="fa fa-edit"></i> Editar</a></li>
						<li><a href="'.full_url.'/web/files/Cuadros/'.$list['NumProducto'].'.pdf" class="" target="_blank" title="Imprimir Cuadro"><i class="fa fa-file-pdf-o"></i> Cuadro TUGRUERO</a></li>
						<li><a href="'.full_url.'/web/files/Cuadros/'.$list['NumProducto'].'_carnet.pdf" class="" target="_blank" title="Imprimir Cuadro"><i class="fa fa-file-pdf-o"></i> Carnet TUGRUERO</a></li>
					...
					$array_json['data'][] = array(
						...
						<ul class="dropdown-menu dropdown-menu-right">
						<li><a href="'.full_url.'/adm/solicitud_plan/index.php?action=edit&idSolicitudPlan='.$idSolicitudPlan.'"> <i class="fa fa-edit"></i> Editar</a></li>
						<li><a href="'.full_url.'/web/files/Cuadros/'.$list['PolizaAsistir'].'.pdf" class="" target="_blank" title="Imprimir RCV"><i class="fa fa-file-pdf-o"></i> Cuadro TUGRUERO</a></li>
						<li><a href="'.full_url.'/web/files/Cuadros/'.$list['PolizaAsistir'].'_carnet.pdf" class="" target="_blank" title="Imprimir RCV"><i class="fa fa-file-pdf-o"></i> Carnet TUGRUERO</a></li>
